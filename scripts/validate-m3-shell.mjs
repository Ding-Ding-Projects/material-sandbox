...
const checks = [
  ...
  [optionsSource.includes('nativeDns') && optionsSource.includes('ui.tabsInternet->insertTab(dnsIndex, nativeDns') && optionsSource.includes('ui.treeDns = new QTreeWidget(nativeDns)') && optionsSource.includes('ui.btnAddDns = new QPushButton(tr('), 'options dns-filter child tab is rebuilt with native controls'],
  [optionsSource.includes('nativeProxy') && optionsSource.includes('ui.tabsInternet->insertTab(proxyIndex, nativeProxy') && optionsSource.includes('ui.treeProxy = new QTreeWidget(nativeProxy)') && optionsSource.includes('ui.btnTestProxy = new QPushButton(tr('), 'options internet-proxy child tab is rebuilt with native controls'],
  [optionsSource.includes('nativeNetConfig') && optionsSource.includes('ui.tabsInternet->insertTab(netConfigIndex, nativeNetConfig') && optionsSource.includes('ui.chkBlockSamba = new QCheckBox(tr(') && optionsSource.includes('ui.cmbNIC = new QComboBox(nativeNetConfig)'), 'options network-config child tab is rebuilt with native controls'],
  [optionsSource.includes('replaceRecoveryControl') && optionsSource.includes('nativeAutoRecovery') && optionsSource.includes('ui.treeRecIgnore = nativeRecIgnore') && optionsSource.includes('ui.btnAddRecIgnoreExt = nativeAddIgnoreExt'), 'options immediate-recovery controls are rebuilt with native Material 3 controls'],
  [optionsSource.includes('replaceQuickRecoveryControl') && optionsSource.includes('nativeRecoveryTree') && optionsSource.includes('ui.chkShowRecoveryTmpl = nativeShowTemplates') && optionsSource.includes('ui.btnAddRecovery = nativeAddRecovery'), 'options quick-recovery controls are rebuilt with native Material 3 controls'],
  [optionsSource.includes('replaceDllControl') && optionsSource.includes('nativeDllTree') && optionsSource.includes('ui.chkHostProtect = nativeHostProtect') && optionsSource.includes('ui.chkHostProtectMsg = nativeHostProtectMsg'), 'options DLL and extension controls are rebuilt with native Material 3 controls'],
  [optionsSource.includes('replaceOptionControl') && optionsSource.includes('nativeOptionsTree') && optionsSource.includes('ui.btnAddOption = nativeAddOption') && optionsSource.includes('ui.chkShowOptionsTmpl = nativeShowOptions'), 'options miscellaneous controls are rebuilt with native Material 3 controls'],
  [optionsSource.includes('replaceUserControl') && optionsSource.includes('nativeUsers') && optionsSource.includes('ui.btnAddUser = nativeAddUser') && optionsSource.includes('ui.chkMonitorAdminOnly = nativeMonitorAdmin'), 'options users controls are rebuilt with native Material 3 controls'],
  [optionsSource.includes('migrateTraceCheck') && optionsSource.includes('ui.chkDisableMonitor') && optionsSource.includes('ui.chkErrTrace'), 'options tracing controls are rebuilt with native Material 3 controls'],
  [optionsSource.includes('replaceCfgControl') && optionsSource.includes('nativeCfgNoGlobal') && optionsSource.includes('ui.btnCfgUpdate = nativeCfgUpdate'), 'options config-dump controls are rebuilt with native Material 3 controls'],
  [optionsSource.includes('replaceTemplateControl') && optionsSource.includes('nativeTemplateTree') && optionsSource.includes('ui.txtTemplates = nativeTemplateFilter') && optionsSource.includes('ui.btnAddTemplate = nativeAddTemplate'), 'options app-template controls are rebuilt with native Material 3 controls'],
  [optionsSource.includes('nativeFolderTree') && optionsSource.includes('ui.gridLayout_42->replaceWidget') && optionsSource.includes('ui.treeFolders = nativeFolderTree'), 'options template-folder tree is rebuilt with native Material 3 controls'],
  [optionsSource.includes('nativeScreenReaders') && optionsSource.includes('ui.gridLayout_43->replaceWidget') && optionsSource.includes('ui.chkScreenReaders = nativeScreenReaders'), 'options accessibility control is rebuilt with native Material 3 controls'],
  [optionsSource.includes('replaceIniControl') && optionsSource.includes('nativeIniText') && optionsSource.includes('ui.btnSaveIni = nativeSaveIni') && optionsSource.includes('ui.chkValidateIniKeys = nativeIniValidate'), 'options ini-editor controls are rebuilt with native Material 3 controls'],
  [optionsSource.includes('replaceProcessControl') && optionsSource.includes('nativeProcessTree') && optionsSource.includes('ui.btnAddProcess = nativeAddProcess') && optionsSource.includes('ui.chkHideHostApps = nativeHideHost'), 'options process-hiding controls are rebuilt with native Material 3 controls'],
  [optionsSource.includes('replacePrivacyControl') && optionsSource.includes('nativeHideFirmware') && optionsSource.includes('ui.cmbLangID = nativeLang') && optionsSource.includes('ui.btnDumpFW = nativeDump'), 'options privacy controls are rebuilt with native Material 3 controls'],
  [optionsSource.includes('migrateCompatCheck') && optionsSource.includes('ui.chkPreferExternalManifest') && optionsSource.includes('ui.chkUseElectronDetection'), 'options compatibility controls are rebuilt with native Material 3 controls'],
  [optionsSource.includes('replaceTriggerControl') && optionsSource.includes('nativeTriggerTree') && optionsSource.includes('ui.btnAddRecoveryCmd = nativeAddRecovery') && optionsSource.includes('ui.chkShowTriggersTmpl = nativeShowTemplates'), 'options trigger controls are rebuilt with native Material 3 controls'],
  [optionsSource.includes('nativeDebugScroll') && optionsSource.includes('ui.gridLayout_87->replaceWidget') && optionsSource.includes('nativeDebugScroll->setWidget(ui.dbgWidget)'), 'options debug scroll host is rebuilt with native Material 3 controls'],
  [optionsSource.includes('nativeDebugTabs') && optionsSource.includes('ui.gridLayout_31->replaceWidget') && optionsSource.includes('ui.tabsDebug = nativeDebugTabs'), 'options debug tab host is rebuilt with native Material 3 controls'],
  [optionsSource.includes('nativeDebugTabs->setTabPosition(QTabWidget::North)') && optionsSource.includes('nativeDebugTabs->setAccessibleName') && optionsSource.includes('nativeDebugScroll->setAccessibleName'), 'options debug tabs keep readable tab order and accessible names'],
  [optionsSource.includes('nativeTemplateTabs') && optionsSource.includes('ui.gridLayout_5->replaceWidget') && optionsSource.includes('ui.tabsTemplates = nativeTemplateTabs'), 'options app-template tab host is rebuilt with native Material 3 controls'],
  [optionsSource.includes('nativeOtherTabs') && optionsSource.includes('ui.gridLayout_12->replaceWidget') && optionsSource.includes('ui.tabsOther = nativeOtherTabs'), 'options various-options tab host is rebuilt with native Material 3 controls'],
  [optionsSource.includes('nativeAdvancedTabs') && optionsSource.includes('ui.gridLayout_121->replaceWidget') && optionsSource.includes('ui.tabsAdvanced = nativeAdvancedTabs'), 'options advanced tab host is rebuilt with native Material 3 controls'],
  [optionsSource.includes('nativeGeneralTabs') && optionsSource.includes('ui.gridLayout_9->replaceWidget') && optionsSource.includes('ui.tabsGeneral = nativeGeneralTabs'), 'options general tab host is rebuilt with native Material 3 controls'],
  [optionsSource.includes('nativeSecurityTabs') && optionsSource.includes('ui.gridLayout_7->replaceWidget') && optionsSource.includes('ui.tabsSecurity = nativeSecurityTabs'), 'options security tab host is rebuilt with native Material 3 controls'],
  [optionsSource.includes('nativeForceTabs') && optionsSource.includes('ui.gridLayout_6->replaceWidget') && optionsSource.includes('ui.tabsForce = nativeForceTabs'), 'options program-control tab host is rebuilt with native Material 3 controls'],
