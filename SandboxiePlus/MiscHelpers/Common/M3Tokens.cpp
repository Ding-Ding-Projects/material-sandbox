...
{
    // Material seed customization is user controlled.  Choose the stronger
    // of the two design-system foregrounds without changing the seed itself.
    return background.lightnessF() > 0.62 ? QColor(QStringLiteral("#1D1B20"))
