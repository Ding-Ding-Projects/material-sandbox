...
**Source baseline documented here:** `d189d9e9` (the current contributor-safe Material desktop integration baseline with runtime smoke, Qt typography controls, Day Teet Hui settings search, notification regex tooling, aggregate cleanup confirmation, and scheduled-source status).
...
| Native CI evidence | [Run 31303525765](https://github.com/Ding-Ding-Projects/material-sandbox/actions/runs/31303525765) completed successfully for x64/ARM64 Qt builds and the bounded x64 startup smoke; [run 31301196079](https://github.com/Ding-Ding-Projects/material-sandbox/actions/runs/31301196079) retains the uploaded JSON evidence | [`docs/features/native-ci-evidence.md`](docs/features/native-ci-evidence.md) |
