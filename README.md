...
**Source baseline documented here:** `cf9aec40` (the current contributor-safe Material desktop integration baseline with runtime smoke, Qt typography controls, Day Teet Hui settings search, notification regex tooling, and aggregate cleanup confirmation).
...
| Native CI evidence | [Run 31303067607](https://github.com/Ding-Ding-Projects/material-sandbox/actions/runs/31303067607) completed successfully for x64/ARM64 Qt builds; [run 31301196079](https://github.com/Ding-Ding-Projects/material-sandbox/actions/runs/31301196079) proves the bounded x64 SandMan startup smoke with uploaded JSON evidence | [`docs/features/native-ci-evidence.md`](docs/features/native-ci-evidence.md) |
