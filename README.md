...
**Source baseline documented here:** `30d35776` (the current contributor-safe Material desktop integration baseline with runtime smoke, Qt typography controls, Day Teet Hui settings search, and notification regex tooling).
...
| Native CI evidence | [Run 31302587016](https://github.com/Ding-Ding-Projects/material-sandbox/actions/runs/31302587016) completed successfully for x64/ARM64 Qt builds; [run 31301196079](https://github.com/Ding-Ding-Projects/material-sandbox/actions/runs/31301196079) proves the bounded x64 SandMan startup smoke with uploaded JSON evidence | [`docs/features/native-ci-evidence.md`](docs/features/native-ci-evidence.md) |
