# Material desktop screenshot gallery
...
The gallery intentionally labels assets as assets. A built-app screenshot is only added after the Qt/MSVC headless capture has rendered the corresponding surface.
